...
def add_as_to_data_base():
    ...
    for i in range(100):
        ...
        _as = Assessment.objects.get(assessment_id=fake.random_int(min=1, max=100))
...
def add_course_to_data_base():
    ...
    course = Course.objects.create(course_name=course_name, course_code=course_code,
                                   ...
                                   type=type, cilos=cilos, assessment=assessment,
                                   pre_request_course_id=pre_request_course_id)
