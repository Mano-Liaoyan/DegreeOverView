    ...
    showSeeksGraph(query) {
      var __graph_json_data = {
        ...
        nodes: [
          ...
          { id: '3', text: 'CILO-3', data: { course: 'Object-Oriented Programming', content: 'fcrvgdr'} },
          { id: '4', text: 'CILO-4', data: { course: 'Data Structures', content: 'efcefcadcaccdc'} },
          { id: '5', text: 'CILO-4', data: { course: 'Data Algorithms', content: 'asdwcfege'} },
